...
The goal is to make a simple color selector web app:
	+ It should work on the current versions of IE and Chrome
	...
	+ Feel free to create an Angular or React UI if you prefer it to simple HTML / javascript (you would need to add the frameworks as well)
